...
namespace Spider
{
	...
	/// </summary>
	public class SpiderForm : System.Windows.Forms.Form, SpiderStatusListener
	{
		...
		private Spider.Engine.Spider m_spider;
		...
		public SpiderForm()
		{
			...
			//
			InitializeComponent();
            //  TOFIX - Clean up thread handling if we are going to keep using this.
		...
		private void InitializeComponent()
		{
            ...
            this.targetURL.Text = "http://localhost/";
            // 
            // threadCount
            // 
            ...
            // txtLog
            // 
            this.txtLog.Location = new System.Drawing.Point(16, 263);
            this.txtLog.Multiline = true;
            this.txtLog.Name = "txtLog";
            this.txtLog.ScrollBars = System.Windows.Forms.ScrollBars.Both;
            this.txtLog.Size = new System.Drawing.Size(440, 329);
        ...
        void SpiderStatusListener.SetLastURL(string str)
        {
            currentURL.Text = str;
        }

        void SpiderStatusListener.AppendLogNote(string str)
        {
            this.txtLog.AppendText(str + "\n");
        }

        void SpiderStatusListener.SetElapsedTime(string str)
        {
            elapsed.Text = str;
        }

        void SpiderStatusListener.SetProcessedCount(string str)
        {
