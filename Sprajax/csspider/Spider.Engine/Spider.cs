...
namespace Spider.Engine
{
	...
	public class Spider
	{
		...
		/// progress to.
		/// </summary>
		private SpiderStatusListener m_spiderForm;
        ...
        /// <summary>
        /// Listeners to document parsing events.
        /// </summary>
        private List<DocumentWorkerListener> m_listeners = new List<DocumentWorkerListener>();
		...
		/// results to.
		/// </summary>
		public SpiderStatusListener ReportTo
		{
			get
			{
				return m_spiderForm;
        ...
        public List<DocumentWorkerListener> Listeners
        {
            get
            {
        ...
        {
            m_spiderForm.AppendLogNote(log);
        }
	}
}
